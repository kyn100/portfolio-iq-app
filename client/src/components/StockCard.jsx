...
const StockCard = ({ stock, onRemove, isWatchlist = false }) => {
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <button
            ...
            title={isWatchlist ? "Remove from watchlist" : "Remove from portfolio"}
          >
          ...
          {stock.historicalData && (
            <div className="mb-4">
              <TechnicalChart
                ...
                movingAverages={analysis?.indicators?.movingAverages}
                bollingerBands={analysis?.indicators?.bollingerBands}
              />
            </div>
          )}
